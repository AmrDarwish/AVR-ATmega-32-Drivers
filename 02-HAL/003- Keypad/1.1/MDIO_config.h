...
#define PORTA_PIN0_INITAL_VALUE 		HIGH
#define PORTA_PIN1_INITAL_VALUE 		HIGH
#define PORTA_PIN2_INITAL_VALUE 		HIGH
#define PORTA_PIN3_INITAL_VALUE 		HIGH
#define PORTA_PIN4_INITAL_VALUE 		HIGH
#define PORTA_PIN5_INITAL_VALUE 		HIGH
#define PORTA_PIN6_INITAL_VALUE 		HIGH
#define PORTA_PIN7_INITAL_VALUE 		HIGH
...
//PORT configuration pin by pin
#define PORTD_PIN0_INITAL_VALUE 		HIGH
#define PORTD_PIN1_INITAL_VALUE 		HIGH
#define PORTD_PIN2_INITAL_VALUE 		HIGH
#define PORTD_PIN3_INITAL_VALUE 		HIGH
#define PORTD_PIN4_INITAL_VALUE 		HIGH
#define PORTD_PIN5_INITAL_VALUE 		HIGH
#define PORTD_PIN6_INITAL_VALUE 		HIGH
#define PORTD_PIN7_INITAL_VALUE 		HIGH
